...
INSERT INTO `user_track` (id, tracklist_id, user_id, track_id, position, cue, created, updated) VALUES
  (1, 9, 1, 3, 3, null, NOW(), NOW()),
  (2, 9, 1, 1, 1, null, NOW(), NOW()),
  (3, 9, 2, 2, 2, null, NOW(), NOW()),
  (4, 9, 1, 9, 9, null, NOW(), NOW()),
  (5, 9, 2, 4, 4, null, NOW(), NOW()),
  (6, 9, 1, 7, 7, null, NOW(), NOW()),
  (7, 9, 3, 10, 10, null, NOW(), NOW()),
  (8, 9, 1, 6, 6, null, NOW(), NOW()),
  (9, 9, 3, 8, 8, null, NOW(), NOW()),
  (10, 1, 3, 12, 2, null, NOW(), NOW()),
  (11, 1, 1, 14, 4, null, NOW(), NOW()),
  (12, 1, 1, 18, 8, null, NOW(), NOW()),
  (13, 1, 1, 16, 6, null, NOW(), NOW()),
  (14, 1, 1, 20, 10, null, NOW(), NOW()),
  (15, 1, 3, 15, 5, null, NOW(), NOW()),
  (16, 1, 2, 13, 3, null, NOW(), NOW()),
  (17, 9, 2, 5, 5, null, NOW(), NOW()),
  (18, 1, 1, 17, 7, null, NOW(), NOW()),
  (19, 1, 3, 11, 1, null, NOW(), NOW()),
  (20, 1, 2, 19, 9, null, NOW(), NOW()),
  (21, 1, 3, 21, 11, null, NOW(), NOW());
